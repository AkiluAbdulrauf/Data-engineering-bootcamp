...
def main(pg_user, pg_pass, pg_host, pg_port, pg_db, target_table, year, month, chunksize):
    """Ingest NYC yellow taxi CSV into Postgres with chunking."""

    base_dir = os.path.dirname(__file__)
    csv_path = os.path.join(base_dir, f"yellow_tripdata_{year}-{month:02d}.csv.gz")
